...
`,E2=["медичний менеджмент і маркетинг,","програми управління здоров'ям для підприємств та бізнесу,","менторство"],Vu=({type:e,children:t,href:n})=>e==="contact"?c.jsx(j2,{href:n,children:t}):e==="services"?c.jsx(O2,{href:n,children:t}):null;Vu.propTypes={type:dn.oneOf(["contact","services"]).isRequired,children:dn.node.isRequired,href:dn.string.isRequired};const C2=()=>c.jsx(v2,{id:"home",children:c.jsxs("div",{className:"container",children:[c.jsx(y2,{children:"Бізнес-партнер з розвитку та комунікацій здорового менеджменту"}),c.jsx(w2,{children:"Будуємо ефективні стратегії здорового менеджменту для медичних брендів:"}),c.jsx(b2,{children:E2.map((e,t)=>c.jsx(S2,{children:e},t))}),c.jsxs(k2,{children:[c.jsx(Vu,{type:"contact",href:"#contact",children:"Консультація"}),c.jsx(Vu,{type:"services",href:"#services",children:"Послуги"})]})]})}),P2=P.section`
  padding-top: 40px;
  padding-bottom: 40px;
...
`,TS=P.svg`
  fill: currentColor;
  stroke: currentColor;
`,nd=({title:e,about:t,comment:n,variant:r,additionalComment:i=!1})=>c.jsxs(jS,{children:[c.jsx(OS,{variant:r,children:e}),c.jsx(ES,{children:t==null?void 0:t.map(o=>c.jsxs(CS,{variant:r,children:[c.jsx(TS,{children:c.jsx("use",{href:ne+"#icon-done"})}),o]},o))}),n&&c.jsx(PS,{additionalComment:i,children:n})]}),_S=P.div`
  padding: 24px;
  display: flex;
  gap: 24px;
  flex-direction: column;
...
`,AS=P.svg`
  ...
  right: 24px;
  top: 24px;
`,RS=({dataList:{details:e,category:t}})=>{const n=Ls();return c.jsxs(_S,{children:[c.jsxs("div",{children:[c.jsx(MS,{symbols:t.length,children:t}),n==="mobile"&&c.jsx(AS,{children:c.jsx("use",{href:ne+"#icon-close"})})]}),e.map((r,i)=>c.jsx(nd,{title:r.title,about:r.about,comment:r.comment,additionalComment:i===0,variant:"projectDetail"},r.title))]})},IS=({dataList:e,isDetailInfoVisible:t,setisDetailInfoVisible:n})=>{const r=Ls(),{category:i,title:o,about:a=[],image:l}=e,s=u=>{n(h=>!h),console.dir(u.target)};return c.jsxs(c.Fragment,{children:[c.jsxs(yS,{children:[c.jsx(kS,{src:l,alt:o,onMouseEnter:s}),c.jsx(SS,{isVisible:t,image:l,className:t?"":"visually-hidden",onMouseLeave:s,children:c.jsx(RS,{dataList:e})}),c.jsx("div",{children:c.jsx(wS,{symbols:i.length,children:i})}),c.jsx(nd,{title:o,about:a,variant:"project"})]}),r==="mobile"&&c.jsx(bS,{children:"Детальніше"})]})},LS=({item:e})=>{const[t,n]=L.useState(!1),r=Ls(),i=()=>{r==="mobile"&&n(o=>!o)};return c.jsx(vS,{onClick:i,children:c.jsx(IS,{dataList:e,isDetailInfoVisible:t,setisDetailInfoVisible:n})})},DS=()=>{const e=Ls(),[t,n]=L.useState(e==="mobile"||e==="tablet"?[...yl.slice(0,1)]:[...yl]),r=()=>{t.length>2?n(i=>i.slice(0,1)):n([...yl])};return c.jsxs(pS,{id:"projects",className:"container",children:[c.jsx(hS,{children:"Проєкти"}),c.jsx(mS,{children:t.map(i=>c.jsx(LS,{item:i},i.category))}),(e==="mobile"||e==="tablet")&&c.jsxs(gS,{onClick:r,children:[t.length>2?"Менше проєктів":"Більше проєктів",c.jsx(xS,{children:c.jsx("use",{href:ne+`${t.length>2?"#icon-arrowup":"#icon-arrowdown"}`})})]})]})},zS=P.section`
  display: flex;
  flex-direction: column;
  padding-top: 40px;
  padding-bottom: 40px;
