...
`,SS=P.svg`
  fill: currentColor;
  stroke: currentColor;
`,nd=({title:e,about:t,comment:n,variant:r,additionalComment:i=!1})=>c.jsxs(xS,{children:[c.jsx(vS,{variant:r,children:e}),c.jsx(yS,{children:t==null?void 0:t.map(o=>c.jsxs(wS,{variant:r,children:[c.jsx(SS,{children:c.jsx("use",{href:ne+"#icon-done"})}),o]},o))}),n&&c.jsx(bS,{additionalComment:i,children:n})]}),kS=P.div`
  padding: 24px;
  display: flex;
  gap: 24px;
  flex-direction: column;
