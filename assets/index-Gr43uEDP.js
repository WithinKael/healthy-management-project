...
`;const s2=[{id:"home",label:"Головна"},{id:"aboutUs",label:"Про нас"},{id:"services",label:"Послуги"},{id:"mentoring",label:"Менторство"},{id:"projects",label:"Проєкти"}],Vu=({width:e,name:t,stroke:n})=>c.jsx("svg",{stroke:n,width:e,height:40,children:c.jsx("use",{href:`${ma}#${t}`})});Vu.propTypes={name:Ot.string.isRequired,stroke:Ot.string.isRequired,width:Ot.string.isRequired};const l2=document.getElementById("modalMobail"),Wg=({onClose:e,handleSetActiveLink:t})=>{const n=wn.useMediaQuery({query:"(max-width: 767px)"});return go.createPortal(c.jsx(t2,{children:c.jsxs("div",{className:"container",children:[c.jsxs(n2,{children:[c.jsx("a",{href:"#home",children:c.jsx(Vu,{name:"icon-g10",width:40})}),c.jsx(r2,{href:"#contact",onClick:r=>{e(),t("contact",r)},children:"Контакт"}),c.jsx(a2,{type:"button",onClick:()=>e(),children:c.jsx(Vu,{name:"icon-close",stroke:"var(--primary-black)",width:n?40:70})})]}),c.jsx(i2,{children:s2.map(({id:r,label:i})=>c.jsx(o2,{href:`#${r}`,onClick:o=>{e(),t(r,o)},children:i},r))})]})}),l2)};Wg.propTypes={onClose:Ot.func.isRequired};const u2=[{id:"home",label:"Головна"},{id:"aboutUs",label:"Про нас"},{id:"services",label:"Послуги"},{id:"mentoring",label:"Менторство"},{id:"projects",label:"Проєкти"}],Bg=({handleSetActiveLink:e})=>{const[t,n]=L.useState("home"),[r,i]=L.useState(!1),o=wn.useMediaQuery({query:"(min-width: 768px) and (max-width: 1439px)"}),a=wn.useMediaQuery({query:"(max-width: 1439px)"}),l=wn.useMediaQuery({query:"(min-width: 1440px)"}),s=()=>i(!r),u=()=>{const h=["home","aboutUs","services","mentoring","projects","contact"].find(x=>{const y=document.getElementById(x);if(y){const m=y.getBoundingClientRect();return m.top<=120&&m.bottom>=120}return y});h&&n(h)};return L.useEffect(()=>(r?document.body.style.overflow="hidden":document.body.style.overflow="auto",window.addEventListener("scroll",u),()=>window.removeEventListener("scroll",u)),[r]),c.jsxs(Qb,{children:[c.jsx("div",{className:"container",children:c.jsxs(Kb,{children:[(a||l)&&c.jsx("a",{href:"#home",children:c.jsx("svg",{width:l?"227":"40",height:"40",children:c.jsx("use",{href:l?`${ne}#logo-black`:`${ma}#icon-g10`})})}),l&&c.jsx(Jb,{children:u2.map(p=>c.jsx(qb,{href:`#${p.id}`,className:t===p.id?"active":"",onClick:h=>e(p.id,h),children:p.label},p.id))}),c.jsx(Gb,{href:"#contact",className:t==="contact"?"active":"",onClick:p=>e("contact",p),children:"Контакт"}),(a||o)&&c.jsx(e2,{type:"button",onClick:s,children:c.jsx(Zb,{children:c.jsx("use",{href:o?`${ma}#icon-menuburgerhorizontaltablet`:`${ma}#icon-menuburger`})})})]})}),a&&r&&c.jsx(Wg,{onClose:s,handleSetActiveLink:e})]})};Bg.propTypes={handleSetActiveLink:Ot.func.isRequired};const c2="/healthy-management-project/assets/hero1x-6AVSlzud.webp",d2="/healthy-management-project/assets/hero@2x-N6Dvbfg6.jpg",f2="/healthy-management-project/assets/hero1x-d4IOBsel.jpg",p2="/healthy-management-project/assets/hero@2x-qDoBpvI0.jpg",h2="/healthy-management-project/assets/hero@1x-gjNVfS_G.jpg",m2="/healthy-management-project/assets/hero@2x-xeAfw2Nx.jpg",g2="/healthy-management-project/assets/hero@1x-T7izVw7M.jpg",x2="/healthy-management-project/assets/hero@2x-MzaNEgZc.jpg",v2=P.section`
...
`,iS=()=>c.jsx($g,{className:"container",children:c.jsxs(Yg,{children:[c.jsxs(Xg,{children:[c.jsxs(Qg,{children:[c.jsx(Jg,{children:"Індивідуальна ментор сесія"}),c.jsx(Gg,{children:"Вирішення вашого індивідуального запиту"}),c.jsx(Zg,{children:"від 1 години"}),c.jsx(ex,{href:"#contact",children:"Замовити послугу"})]}),c.jsxs(Kg,{children:[c.jsx(qg,{children:"Питання, з якими можете звернутися"}),c.jsxs(nx,{children:[c.jsx(Yt,{children:"Незалежна думка щодо маркетингу та розвитку"}),c.jsx(Yt,{children:"Порада по створенню відділу маркетингу або оцінка існуючої структури"}),c.jsx(Yt,{children:"Питання по роботі з підрядниками"}),c.jsx(Yt,{children:"Порада щодо оптимізації бізнес-процесів"}),c.jsx(Yt,{children:"Як вірно оцінити ефективність маркетингових дій"}),c.jsx(Yt,{children:"Які інструменти комунікацій використовувати"}),c.jsxs(Yt,{children:["Особисте питання по менеджменту та розвитку з питань управління"," ","здоров'ям"]})]})]})]}),c.jsx(tx,{children:"Шлях проведення менторської сесії"}),c.jsxs(rS,{children:[c.jsxs(Yo,{children:[c.jsx(J,{minWidth:330,maxWidth:767,children:c.jsx(At,{children:c.jsx("use",{href:`${ne}#icon-rectangle-mob`})})}),c.jsx(J,{minWidth:768,maxWidth:1439,children:c.jsx(At,{children:c.jsx("use",{href:`${ne}#icon-rectangle-tab`})})}),c.jsx(J,{minWidth:1440,children:c.jsx(At,{children:c.jsx("use",{href:`${ne}#icon-rectangle`})})}),c.jsx(Xo,{children:"Заповнення брифу"})]}),c.jsxs(Yo,{children:[c.jsx(J,{minWidth:330,maxWidth:767,children:c.jsx(At,{children:c.jsx("use",{href:`${ne}#icon-rectangle-mob`})})}),c.jsx(J,{minWidth:768,maxWidth:1439,children:c.jsx(At,{children:c.jsx("use",{href:`${ne}#icon-rectangle-tab`})})}),c.jsx(J,{minWidth:1440,children:c.jsx(At,{children:c.jsx("use",{href:`${ne}#icon-rectangle`})})}),c.jsx(Xo,{children:"Діагностика ситуації"})]}),c.jsxs(Yo,{children:[c.jsx(J,{minWidth:330,maxWidth:767,children:c.jsx(At,{children:c.jsx("use",{href:`${ne}#icon-rectangle-mob`})})}),c.jsx(J,{minWidth:768,maxWidth:1439,children:c.jsx(At,{children:c.jsx("use",{href:`${ne}#icon-rectangle-tab`})})}),c.jsx(J,{minWidth:1440,children:c.jsx(At,{children:c.jsx("use",{href:`${ne}#icon-rectangle`})})}),c.jsx(Xo,{children:"Проведення сесії"})]}),c.jsxs(Yo,{children:[c.jsx(J,{minWidth:330,maxWidth:767,children:c.jsx(At,{children:c.jsx("use",{href:`${ne}#icon-rectangle-mob`})})}),c.jsx(J,{minWidth:768,maxWidth:1439,children:c.jsx(At,{children:c.jsx("use",{href:`${ne}#icon-rectangle-tab`})})}),c.jsx(J,{minWidth:1440,children:c.jsx(At,{children:c.jsx("use",{href:`${ne}#icon-rectangle`})})}),c.jsx(Xo,{children:"Рекомендації"})]})]})]})}),oS=P.div`
  display: flex;
  flex-direction: column;
  gap: 3px;
