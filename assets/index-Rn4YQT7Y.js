...
`,mj="/healthy-management-project/assets/icon-WQbGU7FW.svg",gj="/healthy-management-project/assets/icon-2-FNpGPcjZ.svg",vj="/healthy-management-project/assets/icon-3-GZg06_37.svg",yj="/healthy-management-project/assets/icon-4-9BBn0thK.svg",Bl=[{title:"Менторство та консультації",about:["Для власників та менеджерів з питань менеджменту та розвитку, медичного маркетингу та комунікацій, з питань програм управління здоров'ям","Стейхолдерам та парнерам з питань медичного менеджменту та маркетингу"],path:mj},{title:"Діагностика",about:["Аудит бізнес-процесів","Аудит маркетингу та сервісу","Аудит системи комунікацій та Сustomer Journey Map"],path:gj},{title:"Стратегії",about:["Проведення стратегічних сесій","Розробка стратегії розвитку та маркетингу ","Розробка стратегій внутрішніх комунікацій","Розробка стратегій управління здоров'ям"],path:vj},{title:"Навчання",about:["Медичний маркетинг","Комунікації та сервіс"],path:yj}],xj=()=>c.jsx(sj,{className:"container",id:"services",children:c.jsxs(aj,{children:[c.jsx(lj,{children:"Послуги"}),c.jsxs(uj,{children:["Будуємо ефективні ",c.jsx(cj,{children:"стратегії здорового менеджменту"})," для бізнесів. Розвивайте свій бізнес за допомогою ефективних стратегій здорового менеджменту."]}),c.jsx(dj,{children:Bl==null?void 0:Bl.map(e=>c.jsxs(fj,{children:[c.jsx(nd,{title:e.title,about:e.about,additionalComment:!0}),c.jsx(pj,{children:c.jsx("img",{src:e.path,alt:""})})]},e.title))}),c.jsx(hj,{href:"#contact",children:"Замовити консультацію"})]})});function wj(){const e=(t,n)=>{n.preventDefault();const r=document.getElementById(t);if(r){const i=r.getBoundingClientRect(),o=window.pageYOffset||document.documentElement.scrollTop;let s;const l=window.innerWidth;l<=768&&(s=i.top+o-80),(l>768||l<=1440)&&(s=i.top+o-80),l>1440||l<=1920?s=i.top+o-80:s=i.top+o-60,window.scrollTo({top:s,behavior:"smooth"}),setTimeout(()=>{n.target.blur()},1e3)}};return c.jsxs(c.Fragment,{children:[c.jsx(Vg,{handleSetActiveLink:e}),c.jsxs("main",{children:[c.jsx(MS,{}),c.jsx(Ew,{}),c.jsx(fw,{}),c.jsx(AS,{}),c.jsx(Qb,{}),c.jsx(xj,{}),c.jsx(XS,{}),c.jsx(rb,{}),c.jsx(ob,{}),c.jsx(Db,{}),c.jsx(Rw,{}),c.jsx(oj,{})]}),c.jsx(Ag,{handleSetActiveLink:e}),c.jsx(Kb,{})]})}Hl.createRoot(document.getElementById("root")).render(c.jsx(Ce.StrictMode,{children:c.jsx(wj,{})}));
